$(document).ready(function() {
    ...
    function affiche_matiere() {
        $.ajax({
            ...
            success: function(data) {
                if (data.length > 0) {
                    var table_affichage = "<div class='table_etudiant'> <table class='table table-striped  m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Nom de la matiere</th><th>Actions</th></thead><tbody>";
                    for (var i = 0; i < data.length; i++) {
