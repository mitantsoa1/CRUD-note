        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    table_affichage = table_affichage + "<tr><td>" + data[i].nom_matiere + "</td><td><input type='number' class='form-control input' data-id='" + data[i].id_matiere + "'></td></tr>";
                }
