...
<body>
    <div class="container note-content">
        ...
        <form action="" id="formulaire" class="form-inline">
            ...
            <input type="number" id="fr" class="form-control">
            <label for="">Malagasy</label>
            <input type="number" id="mal" class="form-control">
            <label for="">Mathématiques</label>
            <input type="number" id="maths" class="form-control">
            <label for="">Anglais</label>
            <input type="number" id="ang" class="form-control">
