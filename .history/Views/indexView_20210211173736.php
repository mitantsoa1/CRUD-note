...
<body>
    <div class="container content">
        ...
        <form class="form-group myForm" id="formulaire">
            ...
            <a href="#" id="btn_modification" class="hide btn btn-success">Modifier</a>
            <a href="#" id="btn_annuler" class="hide btn btn-info hide">Annuler</a>
            <a href="note">attribuer des notes</a>
        </form>
