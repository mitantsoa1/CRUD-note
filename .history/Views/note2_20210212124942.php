...
<body>
    <div class="container note-content">
        ...
        <form action="" id="formulaire">
            ...
            <input type="number" id="fr" class="form-controle"><br>
            <label for="">Malagasy</label>
            <input type="number" id="mal" class="form-controle"><br>

            <label for="">Mathématiques</label>
            <input type="number" id="maths" class="form-controle"><br>
            <label for="">Anglais</label>
            <input type="number" id="ang" class="form-controle"><br>
