...
<body>
        ...
        <form action="" id="formulaire">
            ...
            <?php 
                ...
                $tab = $db->select("etudiant")
                            ->execute(null);
                echo "<div class='form-group'><label> Etudiant</label> <select id='select_etudiant_note' class='form-control'>
    ...
    <div class="container">
        <div class="total_note"></div>
    </div>
    

 <?php
Controllers::includeJS(["jquery","bootstrap.min","all","sweetalert2.min","form-plugin","note2","note_function"]);
?>    
</body>
</html>